...
return(
 ...
 <div className="mb-8">
   ...
   <Albums />
        ...
        <h1 className='text-xl p-2 m-2'>Weekly Top <span className="text-red font-bold">Songs</span> </h1>

          <Topsongs/>
          <h1 className='text-xl p-2 m-2'>New Releases <span className="text-red font-bold">Songs</span></h1>
       <Newrelease/>
       <h1 className='text-xl p-2 m-2'>Trending <span className="text-red font-bold">Songs</span></h1>
       <Topsongs names={"trending songs 2024"}/>
       <h1 className='text-xl p-2 m-2'>Popular<span className="text-red font-bold">Artists</span></h1>
       <Artist/>
       <h1 className='text-xl p-2 m-2'>Popular<span className="text-red font-bold">Albums</span></h1>
       <Albums/>
       <div className='h-2/6'>
