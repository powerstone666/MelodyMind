        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 xl:grid-cols-6 gap-4">
          {Array(12).fill(0).map((_, index) => (
            <div key={index} className="animate-pulse">
              <div className="bg-gray-800 rounded-full aspect-square mb-3"></div>
        ...
        {musicInfo.slice(0, Viewall ? musicInfo.length : limit).map((item, index) => (
          ...
          >
            <div className="flex flex-col items-center">
              <div className="relative mb-3 rounded-full overflow-hidden aspect-square w-full bg-gradient-to-br from-gray-800 to-gray-900 p-1 group-hover:from-melody-pink-900 group-hover:to-purple-900 transition-all duration-300">
      ...
      {!Viewall && musicInfo.length > limit && (
        <div className="flex justify-center mt-8">
          <button
            ...
            className="px-6 py-2 bg-melody-pink-600 hover:bg-melody-pink-700 text-white rounded-full transition-colors duration-300"
          >
            Show More
          </button>
        </div>
