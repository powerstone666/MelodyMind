...
function Discover() {
  ...
  return (
    <>
      {isAboveMedium ? (
        <div
          className="overflow-y-auto h-screen w-full mb-12 no-scrollbar"
          style={{ minWidth: "100%" }}
        >
             <div className="mb-8">
            <h1 className="text-3xl p-4 m-5">
              New Releases <span className="text-melody-pink-500 font-bold">Songs</span>
            </h1>
            <Newrelease />
          </div>
          <div className="mb-8">
            <h1 className="text-3xl p-4 m-5">
              Trending <span className="text-melody-pink-500 font-bold">Songs</span>
            </h1>
            <Trending />
          </div>
          <div className="mb-8">
            <h1 className="text-3xl p-4 m-5">
              Weekly Top <span className="text-melody-pink-500 font-bold">Songs</span>
            </h1>
            <Topsongs />
          </div>
          <div className="mb-8">
