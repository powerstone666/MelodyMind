            ...
            {!loading ? (
                <>
                    {localUser ? (
                        <>
                            {isAboveMedium ? (
                                <div className="h-screen w-5/6 m-12 mb-28 flex flex-col bg-gradient-to-br from-deep-grey to-deep-blue border border-gray-700 shadow-lg rounded-lg overflow-y-auto no-scrollbar pb-32 pt-4">
                                ...
                                <div className="h-screen w-full mb-28 flex flex-col bg-gradient-to-br from-deep-grey to-deep-blue border border-gray-700 shadow-lg overflow-y-auto no-scrollbar pb-32 pt-4">
